 ...
 */
export function createSigV4Fetch(options: SigV4FetchOptions): (input: any, init?: any) => Promise<any> {
  ...
  return async (input: any, init?: any): Promise<any> => {
    ...
    let Sha256: any;
    try {
      SignatureV4 = (await import(/* webpackIgnore: true */ '@smithy/signature-v4')).SignatureV4;
      Sha256 = (await import(/* webpackIgnore: true */ '@aws-crypto/sha256-js')).Sha256;
    } catch {
      throw new Error(
    ...
    if (init?.headers) {
      ...
      if (typeof h === 'object' && h !== null && typeof h.forEach === 'function') {
